...
def main() -> None:
    ...
    # widget gallery only lives at "/gallery" (see docs/implementation_plan.md §10.4).
    print("Open http://localhost:8080/gallery in your browser to view the widget gallery.")
    app.run()
